	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_xh8m93v_caption)#",
					"color": "primary",
					"disabled": false,
					"size": "medium",
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_1e18lg6_caption)#",
					"color": "warn",
					"disabled": false,
					"size": "medium",
					"iconPosition": "only-text",
			...
			{
				"operation": "insert",
				"name": "MenuItem_y1xfyji",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_y1xfyji_caption)#",
					"visible": true,
					"clicked": {
				...
				"parentName": "Button_1e18lg6",
				"propertyName": "menuItems",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "MenuItem_pq1o8jk",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_pq1o8jk_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.RunBusinessProcessRequest",
						"params": {
							...
							"processRunType": "ForTheSelectedPage",
							"recordIdProcessParameterName": "IdParameter"
						}
					}
				},
				"parentName": "Button_1e18lg6",
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.LookupAttribute_lqlkw76;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.LookupAttribute_c4nq3q7;
					var offerTypeId = "";
					if (offerTypeObject) {
